...
export default function MarkdownPreview({
  ...
  return (
    <label
      htmlFor="preview"
      className="inline-block w-full overflow-auto md:flex md:flex-col md:items-center lg:items-center"
    >
