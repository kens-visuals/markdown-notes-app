        ...
        <div className="flex items-center gap-2">
          ...
          >
            <input
              ...
              className="w-1/2 border-b border-transparent bg-transparent transition-[border] duration-300 focus-visible:border-b focus-visible:border-b-white focus-visible:outline-none"
            />
          </form>
        </div>
      </div>
